...
public class HttpTasksTest extends HttpTaskManagerTest{
  ...
  public void getTasksReturnsAnEmptyListFromNewTaskManager()
  ...
  public void getTasksReturnsAnValidListFromTaskManager()
      throws IOException, InterruptedException {
    /* Given */
  ...
  public void getTasksByIdReturnsAnValidTaskFromManager()
      throws IOException, InterruptedException {
    /* Given */
  ...
  public void postTasksShouldAddTaskToTheTaskManager()
      throws IOException, InterruptedException {
    /* Given */
  ...
  public void postTasksByIdShouldUpdateTaskWithNewStartTime()
      throws IOException, InterruptedException {
    /* Given */
  ...
  public void deleteTasksByIdShouldDeleteTaskFromTaskManager()
      throws IOException, InterruptedException {
    /* Given */
    final Task existedTask = manager.addTask(
        TestDataBuilder.buildTask(1, "task", "d", TaskStatus.NEW, Duration.ofMinutes(15),
